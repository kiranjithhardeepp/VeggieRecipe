...
const handleSearch = (e) => {
  ...
  return (
    <div className='px-6 lg:px-12 py-20'>
        ...
        <input value={query} onChange={handleSearch} className='outline-none w-full placeholder:text [#1b2629]' name="query" type="search" placeholder='Search for a recipe' id="search" required=" "/>
        </div>
