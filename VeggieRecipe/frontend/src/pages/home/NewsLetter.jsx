...
const NewsLetter = () => {
  return (
    <div className='w-full md:w-2/3 mx-auto flex flex-col items0center p-10'>
        ...
        <p className='mt-6 text-gray-600 text-lg text-center leading-normal font-light'>
            Weekly emails with my latest recipes, cooking tips and tricks and product recommendations!<bt /> You'll be set up in minutes.
        </p>
