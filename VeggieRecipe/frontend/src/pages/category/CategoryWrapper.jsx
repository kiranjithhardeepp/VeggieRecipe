...
function CategoryList() {
    return(
        <div className='flex felx-wrap items-center justify-center gap-8'>
            <CategoryItem name="entrees" href="/categories/entrees" backgroundColor="#f0f5c4" color="#59871f"/>
            <CategoryItem name="breakfast" href="/categories/breakfas" backgroundColor="#efedfa" color="#3c3a8f"/>
