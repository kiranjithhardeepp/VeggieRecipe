...
async function main() {
  try {
    await mongoose.connect(
      "mongodb+srv://nandithanataraj10092002:5wmSEUIUVXfikaOc@veggify-recipe-app.bavu5.mongodb.net/veggify-recipe-app?retryWrites=true&w=majority&appName=veggify-recipe-app"
    );
